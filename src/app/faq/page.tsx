            ...
            <section className="py-32 px-8">
                <div className="max-w-3xl mx-auto space-y-24">
                    ...
                    <div className="pt-20 border-t border-white/5 text-center">
                        ...
                        <Link href="/contact" className="inline-block px-12 py-4 bg-white text-black text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-[#a932bd] hover:text-white transition-all rounded-sm">
                            Contact Concierge
                        </Link>
                    </div>
                </div>
