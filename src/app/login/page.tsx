...
export default function LoginPage() {
  ...
  return (
    <div className="bg-[#050406] dark:bg-[#050406] font-sans text-slate-100 min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <main className="w-full glass-card rounded-xl p-8 iridescent-border">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2 group">
              ...
              <div className="relative input-glow rounded-lg border border-white/10 bg-black/20 flex items-center px-4 transition-all duration-300">
