...
async function main() {
  ...
  await prisma.product.upsert({
    ...
    create: {
      id: 'tsg-acc-001', name: 'Holographic Silk Scarf',
      description: 'Limited edition scarf with tsgabrielle holographic weave.',
      price: 250.00, category: 'accessories', imageUrl: '/images/products/scarf-holographic.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-acc-002', name: 'Iridescence Leather Belt',
      description: 'Cruelty-free vegan leather with iridescent coating. Adjustable up to 42".',
      price: 180.00, category: 'accessories', imageUrl: '/images/products/belt-iridescence.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-acc-003', name: 'Crystal Skies Sunglasses',
      description: 'Oversized gradient lenses with titanium frame. UV400 protection.',
      price: 320.00, category: 'accessories', imageUrl: '/images/products/sunglasses-crystal.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-acc-004', name: 'TransLove Enamel Pin Set',
      description: 'Set of 5 collectible enamel pins celebrating trans joy and pride. Gold plating.',
      price: 45.00, category: 'accessories', imageUrl: '/images/products/pins-translove.jpg',
      variants: {
        create: [
  ...
  console.log('✅ Accessories seeded (4 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-hat-001', name: 'Peach Phoenix™ Bucket Hat',
      description: 'Structured terry-cloth bucket hat. Embroidered Peach Phoenix logo.',
      price: 95.00, category: 'hats', imageUrl: '/images/products/hat-peach-phoenix.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-hat-002', name: 'Cosmic Beret',
      description: 'Sculptural wool beret with galaxy-printed lining. One size adjustable.',
      price: 140.00, category: 'hats', imageUrl: '/images/products/hat-cosmic-beret.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-hat-003', name: 'Arizona Rancher Hat',
      description: 'Wide-brim vegan suede hat. Desert-ready with UV protection band.',
      price: 175.00, category: 'hats', imageUrl: '/images/products/hat-arizona.jpg',
      variants: {
        create: [
  ...
  console.log('✅ Hats seeded (3 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-home-001', name: 'Iridescence Candle Set',
      description: 'Set of 3 luxury soy candles. Notes of white tea, iris, and amber. 40-hour burn.',
      price: 120.00, category: 'home-decor', imageUrl: '/images/products/candles-iridescence.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-home-002', name: 'Good Vibes Throw Blanket',
      description: 'Ultra-soft recycled fleece throw. 50"x60". Machine washable.',
      price: 85.00, category: 'home-decor', imageUrl: '/images/products/blanket-good-vibes.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-home-003', name: "Pride '25 Art Print",
      description: "Museum-quality giclée print on archival paper. Certificate of authenticity. Limited to 500.",
      price: 200.00, category: 'home-decor', imageUrl: '/images/products/print-pride25.jpg',
      variants: {
        create: [
  ...
  console.log('✅ Home & Décor seeded (3 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-him-001', name: 'Made In USA Crewneck',
      description: 'Heavyweight 380gsm organic cotton crewneck. GOTS certified. Embroidered flag detail.',
      price: 165.00, category: 'for-him', imageUrl: '/images/products/crewneck-made-in-usa.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-him-002', name: 'Paris Structured Blazer',
      description: 'Tailored unstructured blazer with tsgabrielle monogram lining. Modern slim cut.',
      price: 480.00, category: 'for-him', imageUrl: '/images/products/blazer-paris.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-him-003', name: 'Good Vibes Graphic Tee',
      description: 'Relaxed fit oversized tee with Good Vibes Only print. 100% organic cotton.',
      price: 75.00, category: 'for-him', imageUrl: '/images/products/tee-good-vibes.jpg',
      variants: {
        create: [
  ...
  console.log('✅ For Him seeded (3 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-her-001', name: 'Flamant Rose Silk Slip Dress',
      description: 'Bias-cut silk-satin slip dress in flamingo rose. Adjustable spaghetti straps.',
      price: 395.00, category: 'for-her', imageUrl: '/images/products/dress-flamant-rose.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-her-002', name: 'TransFLOWer Wrap Skirt',
      description: 'Flowy wrap skirt with TransFLOWer motif. Recycled polyester satin.',
      price: 145.00, category: 'for-her', imageUrl: '/images/products/skirt-transflower.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-her-003', name: 'Womanizer Power Suit',
      description: 'Double-breasted blazer + wide-leg trouser set. Stretch crepe.',
      price: 620.00, category: 'for-her', imageUrl: '/images/products/suit-womanizer.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-her-004', name: "Glow in Winter '26 Puffer",
      description: 'Reflective puffer jacket with phosphorescent panels. Glows in the dark. Vegan fill.',
      price: 545.00, category: 'for-her', imageUrl: '/images/products/puffer-winter26.jpg',
      variants: {
        create: [
  ...
  console.log('✅ For Her seeded (4 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-exc-001', name: 'Crystal Skies Corset Top',
      description: 'Hand-beaded corset with Swarovski crystal detailing. Made to order. Ships 4-6 weeks.',
      price: 1200.00, category: 'exclusive', imageUrl: '/images/products/corset-crystal-skies.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-exc-002', name: "Pride '25 Limited Bomber",
      description: "Rainbow-sequined bomber jacket. Numbered edition — only 100 made. Inner sleeve signed.",
      price: 850.00, category: 'exclusive', imageUrl: '/images/products/bomber-pride25.jpg',
      variants: {
        create: [
  ...
  console.log('✅ Exclusive seeded (2 products)')
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-sale-001', name: 'Iridescence Mini Bag [ARCHIVE]',
      description: 'Season-1 archive piece. Nano crossbody in iridescent PVC. Minor cosmetic irregularities.',
      price: 89.00, category: 'sale', imageUrl: '/images/products/bag-iridescence-archive.jpg',
      variants: {
        create: [
  ...
  await prisma.product.upsert({
    ...
    update: {},
    create: {
      id: 'tsg-sale-002', name: 'Cosmic Hoodie [ARCHIVE]',
      description: 'S1 archive hoodie. Galaxy-dye relaxed pullover. Minor fading variation — each is unique.',
      price: 65.00, category: 'sale', imageUrl: '/images/products/hoodie-cosmic-archive.jpg',
      variants: {
        create: [
  ...
  console.log('✅ Sale seeded (2 products)')
  ...
  console.log('   7 categories | 16 products | 90+ variants seeded to Supabase.')
  console.log('')
}
